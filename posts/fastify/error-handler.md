...
description: Understand how Fastify manage your application errors
date: 2020-11-26
tags:
  - fastify
  - error-handling
...
function callbackStyleHandler (request, reply) {
  ...
  'this is not an array'.sort() 
  // fastify will handle the TypeError for you
}
...
![Fastify error lifecycle](/img/error-lifecycle.png)
